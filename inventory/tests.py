...
class ListInventoryStatusTests(TestCase):
    def test_receiving_quantity(self):
        ...
        self.assertEqual(object["results"][0]["receiving_quantity"], 54)
    ...
    def test_shipping_quantity(self):
        ...
        object = response.json()
        self.assertEqual(object["count"], 1)
        self.assertEqual(object["results"][0]["shipping_quantity"], -73)
    ...
    def test_multiple_commodity(self):
        ...
        self.assertEqual(object["results"][0]["shipping_quantity"], -73)
        self.assertEqual(object["results"][0]["receiving_quantity"], 54)
        self.assertEqual(object["results"][1]["shipping_quantity"], -183)
        self.assertEqual(object["results"][1]["receiving_quantity"], 164)
